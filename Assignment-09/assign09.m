function [NN NE NM NP NGPk NGPf NDIM NEN NDOF ND NL NEUDL NRC CORD ELECON MAT BC PLOAD UDL ] = assign08(finp)
...
NGPk = fscanf(finp, '%d',1); % Number of integration points for elemetal Matrix
NGPf = fscanf(finp, '%d',1); % Number of integration points for force matrix
